...
// GetPostsInCollection implements model.CollectionService
func (*collectionService) GetPostsInCollection(ctx context.Context, collectionID uuid.UUID) ([]model.Post, error) {
	panic("unimplemented")
}
